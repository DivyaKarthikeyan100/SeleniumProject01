package com.maheshsirproject.ecommerce.basepage;
...
public class BasePage {
	...
	static
	{
		...
		SimpleDateFormat dateFormat=new SimpleDateFormat("dd_MM_yyyy_hh_mm-SS");
		extent=new ExtentReports(System.getProperty("user.dir")
				+"/src/main/java/com/maheshsirproject/ecommerce/htmlreports/test/"+dateFormat.format(cal.getTime())+".html",false);
	}
	...
	public void browserLaunch(String browser, String url) {
		...
		if (browser.equalsIgnoreCase("firefox")) {
			System.setProperty("webdriver.firefox.driver", "C:\\Users\\Karthik & Divya\\Desktop\\Selenium Course 2020\\Selenium Online Class_2020_DurgaSoft\\July2020_WebDriver\\chromedriver.exe");
			driver = new FirefoxDriver();
		} else if (browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\Karthik & Divya\\Desktop\\Selenium Course 2020\\Selenium Online Class_2020_DurgaSoft\\July2020_WebDriver\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browser.equalsIgnoreCase("ie")) {
			System.setProperty("webdriver.ie.driver", "C:\\Users\\Karthik & Divya\\Desktop\\Selenium Course 2020\\Selenium Online Class_2020_DurgaSoft\\July2020_WebDriver\\IEDriverServer.exe");
